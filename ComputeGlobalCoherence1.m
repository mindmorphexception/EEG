...
% saves global coherence, eigenvectors and eigenvals
    ...
    clearvars -except folderFourier folderGlobalCoherence patientnr nightnr chanlocs91 globalCoherenceWindow globalCoherenceOverlap;
    ...
    nrWindows = length(1:globalCoherenceOverlap:(nrEpochs - windowSize + 1));
    ...
    for f = 1:nrFreqs
        indexWindow = 0;
        for w = 1:globalCoherenceOverlap:(nrEpochs - windowSize + 1)
            ...
            % skip calculating the current glocoh if too many epochs are bad
